...
#%% Chris wackiness to patch the fails

homepage_archive = '''
duo.search_host = 'www.duolingo.com';
duo.feature_flags = {"job_board": true, "show_vocab_page": true, "disable_moderation_tool": false, "show_linkedin_sharing": true, "show_your_edits": true, "show_your_uploads": true, "disable_web_discussions": false, "schools_android_deep_links": true, "schools_people_min_students": 5, "show_translations": false, "disable_comment_follow": false, "allow_web_local_grading_regression": true, "show_stream": true, "disable_web_sentence_discussions": false, "social_teams": true, "enable_proxy_forum_microservice": true, "immersion_search_bar": true, "allow_web_local_grading": true};
duo.js_version = 'dbec1486ca76faff4d2a-vendor.js-dbec1486ca76faff4d2a-duolingo.js';
duo.ab_options = {"web_branded_mobile_buttons_test": false, "signup_modal_buttons_experiment": false, "login_modal_experiment": true};
duo.body_class = "splash-2014";
duo.compact_enabled = duo.script_direction != 'rtl';
duo.tts_base_url = duo.cn_extension ? 'http://web.archive.org/web/20170914233223/http://d7mj4aqfscim2.cloudfront.net/' : 'http://web.archive.org/web/20170914233223/https://d7mj4aqfscim2.cloudfront.net/';
duo.tts_path = 'tts/{voice}/{type}/{id}';
duo.tts_voices = {"dn": "dn/ruben", "el": "el/maria", "en": "en/salli", "pt": "pt/vitoria", "ru": "ru/julia", "tr": "tr/filiz", "nb": "nb/liv", "ko": "ko/hyejin", "it": "it/carla", "sv": "sv/astrid", "cy": "cy/gwyneth", "cs": "cs/female01_cs_cz", "ca": "ca/eurcatalanfemale", "ro": "ro/female01", "ja": "ja/mizuki", "pl": "pl/maja"};
duo.tts_multi_voices = {"dn": ["dn/ruben"], "el": ["el/maria"], "fr": ["fr", "fr/mathieu"], "en": ["en/salli"], "pt": ["pt/vitoria"], "ru": ["ru/julia"], "tr": ["tr/filiz"], "nb": ["nb/liv"], "de": ["de"], "ko": ["ko/hyejin"], "it": ["it/carla"], "sv": ["sv/astrid"], "cy": ["cy/gwyneth"], "es": ["es"], "cs": ["cs/female01_cs_cz"], "ca": ["ca/eurcatalanfemale"], "ro": ["ro/female01"], "da": ["da"], "ja": ["ja/mizuki"], "pl": ["pl/maja"]};
'''
...
#        server_list = re.search('//.+\.cloudfront\.net', self._homepage)
        server_list = list(set(re.findall('//.+\.cloudfront\.net', self._homepage.replace('>', '>\n'))))
        a_server = server_list[0]
#        self._cloudfront_server_url = "https:{}".format(server_list.group(0))
        self._cloudfront_server_url = "https:{}".format(a_server)
    ...
    def _process_tts_voices(self):
        voices_js = re.search('duo\.tts_multi_voices = {.+};',
                              self._homepage)
        voices_js = voices_js.group(0) if voices_js else re.search('duo\.tts_multi_voices = {.+};', homepage_archive).group(0)
